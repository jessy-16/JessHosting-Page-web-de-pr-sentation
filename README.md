...
-Une grille de tarifs avec plusieurs offres (Basic, Pro, Expert)

-Une section d’abonnement détaillant les options et avantages
...
-Présentation des fonctionnalités avec icônes et textes

-Grille de tarifs avec cartes et sélection de plans

-Section abonnement avec détails des offres

-Bannière promotionnelle

-Formulaire de contact avec email et message
...
-index2.html – Page des fonctionnalités (liée depuis le menu)
